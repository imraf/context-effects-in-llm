...
class StrategiesExperiment:
    ...
    def run(self) -> Dict[str, Any]:
        ...
        results['baseline'] = {"response": resp, "correct": self.expected_answer.lower() in resp.lower()}
        ...
        resp = self.client.generate(prompt)
        results['select'] = {"response": resp, "correct": self.expected_answer.lower() in resp.lower()}
        ...
        resp = self.client.generate(prompt)
        results['compress'] = {"response": resp, "correct": self.expected_answer.lower() in resp.lower()}
        ...
        resp = self.client.generate(prompt)
        results['write'] = {"response": resp, "correct": self.expected_answer.lower() in resp.lower()}
